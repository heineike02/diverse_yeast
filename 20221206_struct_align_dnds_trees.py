    ...
    for jj, alignment in enumerate(selected_alignments): 
        ...
        for suffix in suffixes: 
            ...
            shutil.move(og_pep_msa_fname + suffix, 
                            aln_dir + os.sep + os.path.normpath('trim_default/' + alignment + '.tm.fasta' + suffix)
                           )

            og_pep_msa_fname_trimmed = aln_dir + os.sep + os.path.normpath('trim_default/' + alignment + '.tm.fasta.clipkit')
