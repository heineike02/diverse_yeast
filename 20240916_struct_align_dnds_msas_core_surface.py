#Make Strictly trimmed CDS for DN/DS calculation for core and surface of proteins only based on subset from tm_align msas
#
#
#Input: 
# 
...
#
# feature = core or surface
# ?Alignments from msas/structural/tm_align/fasta_renamed/feature_subsets/<feature>/
#                       cds_aln
#                       fasta_renamed
#
#Output: 
...
for feature in ['core','surface']: 
    ...
    with open(filtered_og_log_fname, 'w') as f_out: 
        f_out.write('Orthogroups filtered out when running ' + feature + '_struct_align_dnds_msas because strict trimming of alignment was below trim_msa_thresh=' + str(trim_msa_thresh) + ' * average sequence length threshold\n')
