...
selected_alignments = ['OG1230_REF_Scer_AF-P29465-F1-model_v2', 'OG1364_REF_Scer_AF-P27796-F1-model_v2']
#[fname.split('.')[0] for fname in align_files]

seq_filt_thresh = 0.8 #Threshold percentage of residues that must be present
...
for alignment in selected_alignments: 
    ...
    msa_cds_trimmed_seqs = SeqIO.parse(msa_cds_trimmed_renamed, 'fasta')
    msa_cds_trimmed_filtered = base_dir + os.sep +  os.path.normpath('selection_calculations/m0_yn00_comparison/yn00/alignments/' + alignment +  '.yn00_filtered.fasta')
    ...
    msa_cds_trimmed_phy = base_dir + os.sep +  os.path.normpath('selection_calculations/m0_yn00_comparison/yn00/alignments/' + alignment +  '.yn00_filtered.phy')
    ...
    msa_cds_trimmed_phy_codeML = base_dir + os.sep + os.path.normpath('selection_calculations/m0_yn00_comparison/yn00/alignments/' + alignment +  '.yn00_filtered.codeML.phy')
